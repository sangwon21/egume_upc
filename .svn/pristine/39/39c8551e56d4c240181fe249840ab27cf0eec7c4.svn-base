...
<div id="error">
	<div class="error">
		...
		<h2>오류가 발생하여 요청사항을 수행할 수 없습니다.</h2>
		<p>Sorry A generic error message, given when an unexpected condition was encountered and no more specific message is suitable.</p>
