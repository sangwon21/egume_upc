...
public class MemberInfoController {
	...
	public String modUserInfo(@ModelAttribute UsrInfVO usrInfVO) throws Exception {
		...
		return "redirect:/user/usrinf/userInfo.do";
	}
	...
	public @ResponseBody String checkPw(Principal principal, @RequestParam("pw") String pw) throws Exception {
		String prtnum = principal.getName();
		String result;
		
		result = Boolean.toString(service.checkPw(prtnum, pw));
