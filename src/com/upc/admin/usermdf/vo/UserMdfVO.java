package com.upc.admin.usermdf.vo;

public class UserMdfVO {
	...
	public String toString() {
		return "UserMdfVO [prtnum=" + prtnum + ", pw=" + pw + ", cmpnnm=" + cmpnnm + ", ceonm=" + ceonm + ", addr1="
				+ addr1 + ", addr2=" + addr2 + ", mgrname=" + mgrname + ", mgrtel=" + mgrtel + ", mgrphone=" + mgrphone
				+ ", mgremail=" + mgremail + ", mgrpstn=" + mgrpstn + ", mgrfax=" + mgrfax + ", rmncnt=" + rmncnt
				+ ", prepayyn=" + prepayyn + ", emailyn=" + emailyn + ", emaildt=" + emaildt + ", smsyn=" + smsyn
				+ ", smsdt=" + smsdt + ", sts=" + sts + ", rgsttm=" + rgsttm + ", rgstid=" + rgstid + ", mdftm=" + mdftm
				+ ", mdfid=" + mdfid + ", bsnsfileid=" + bsnsfileid + ", applfileid=" + applfileid + ", filenm="
				+ filenm + ", type=" + type + "]";
	}
