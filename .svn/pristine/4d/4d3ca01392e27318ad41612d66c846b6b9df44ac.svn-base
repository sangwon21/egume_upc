...
<script type="text/javascript">    
	window.onload = function() {
		...
		$("#conditionValue").keyup(function(e){
			if(e.keyCode == 13) setPageIndex();
		});
	...
	// 페이징 버튼 
	function prev() {
		window.location.href=encodeURI("/egume_upc/admin/wrtlist.do?dateCondition=${searchVO.dateCondition}&dateFrom=${searchVO.dateFrom}&dateTo=${searchVO.dateTo}&period=${searchVO.period}&searchCondition=${searchVO.searchCondition}&conditionValue=${searchVO.conditionValue}&searchStatus=${searchVO.searchStatus}&searchWriter=${searchVO.searchWriter}&pageIndex=${searchVO.pageIndex-1}");
	}
	
	function pagingNum(pageIndex){
		window.location.href=encodeURI("/egume_upc/admin/wrtlist.do?dateCondition=${searchVO.dateCondition}&dateFrom=${searchVO.dateFrom}&dateTo=${searchVO.dateTo}&period=${searchVO.period}&searchCondition=${searchVO.searchCondition}&conditionValue=${searchVO.conditionValue}&searchStatus=${searchVO.searchStatus}&searchWriter=${searchVO.searchWriter}&pageIndex="+pageIndex);
	}
