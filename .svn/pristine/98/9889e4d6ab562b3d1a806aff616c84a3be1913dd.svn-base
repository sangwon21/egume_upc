		    		...
		    		<div class="container col-lg-6">
						...
						<table class="userInfo">
							...
							<tr>
								...
								<td colspan="2"><input type="number" class="form-control input-sm" name="prtnum" id="prtnum" value="${userJoinReqDetailVO.prtnum}" readonly >
								</td>
							</tr>
							<tr>
								<td><label for="cmpnnm">상호<span class="text-danger">*</span></label></td>
								<td colspan="2"><input type="text" class="form-control input-sm" name="cmpnnm" id="cmpnnm" onkeyup="fn_cmpnnm()" value="${userJoinReqDetailVO.cmpnnm}" autocomplete="off">
							...
							<tr>
								...
								<td colspan="2"><input type="text" class="form-control input-sm" name="ceonm" id="ceonm" onkeyup="fn_ceonm()" value="${userJoinReqDetailVO.ceonm}" autocomplete="off">
							...
							<tr>
								...
								<td><input type="text" class="form-control input-sm" name="addr1" id="addr1" onkeyup="fn_addr1()" value="${userJoinReqDetailVO.addr1}" autocomplete="off">
							...
							<tr>
								<td></td>
								<td colspan="2"><input type="text" class="form-control input-sm" name="addr2" id="addr2" onkeyup="fn_addr2()" value="${userJoinReqDetailVO.addr2}" autocomplete="off">
							...
							<tr>
								<td><label id="fileLabel">사업자등록증사본<span class="text-danger">*</span></label></td>
								<td>
									<input type="text" class="form-control input-sm" id="bsnsfileid" name="bsnsfileid" style="cursor:pointer" value="${userJoinReqDetailVO.bsnsfilenm}" readonly <c:if test="${userJoinReqDetailVO.bsnsfileid != null}"> onclick="location.href='${pageContext.request.contextPath}/filedownload?fileseq=${userJoinReqDetailVO.bsnsfileid}'" </c:if> >
							...
							<c:if test="${userJoinReqDetailVO.applfileid != null}">
								<td><label for="applfileid" id="fileLabel">가입신청서<span class="text-danger">*</span></label></td>
								<td colspan="2">
									<input type="text" class="form-control input-sm" id="applfileid" name="applfileid" style="cursor:pointer" value="${userJoinReqDetailVO.applfilenm}" readonly <c:if test="${userJoinReqDetailVO.applfileid != null}"> onclick="location.href='${pageContext.request.contextPath}/filedownload?fileseq=${userJoinReqDetailVO.applfileid}'" </c:if> >
								</td>
					        </c:if>
						</table> 
					...
					<div class="container col-lg-6">
						...
						<table class="userInfo">
							...
							<tr>
								...
								<td colspan="2"><input type="text" class="form-control input-sm" name="mgrname" id="mgrname" onkeyup="fn_mgrname()" value="${userJoinReqDetailVO.mgrname}" autocomplete="off">
							...
							<tr>
								...
								<td colspan="2"><input type="text" class="form-control input-sm" name="mgrtel" id="mgrtel" onkeyup="fn_mgrtel()" value="${userJoinReqDetailVO.mgrtel}" autocomplete="off">
							...
							<tr>
								...
								<td colspan="2"><input type="text" class="form-control input-sm" name="mgrphone" id="mgrphone" onkeyup="fn_mgrphone()" value="${userJoinReqDetailVO.mgrphone}" autocomplete="off">
							...
							<tr>
								...
								<td colspan="2"><input type="text" class="form-control input-sm" name="mgrpstn" id="mgrpstn" onkeyup="fn_mgrpstn()" value="${userJoinReqDetailVO.mgrpstn}" autocomplete="off">
							...
							<tr>
								...
								<td colspan="2"><input type="text" class="form-control input-sm" name="mgrfax" id="mgrfax" onkeyup="fn_mgrfax()" value="${userJoinReqDetailVO.mgrfax}" autocomplete="off">
							...
							<tr>
								...
								<td colspan="2"><input type="email" class="form-control input-sm" name="mgremail" id="mgremail" onkeyup="fn_mgremail()" value="${userJoinReqDetailVO.mgremail}" autocomplete="off">
