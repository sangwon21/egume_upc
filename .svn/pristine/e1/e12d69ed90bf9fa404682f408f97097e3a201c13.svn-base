				  ...
				  <div class="w3-row-padding">
				    ...
				    <div class="w3-third">
				      <div class="w3-white w3-text-grey w3-card-4">
				        ...
				        <br>
				          <p class="w3-large">
				          <b><i class="fa fa-asterisk fa-fw w3-margin-right w3-text-teal"></i>발급결과</b></p>
            ...
            <div class="container-fluid toggle">
                <div class="row">
					...
					<div class='container adminContainer'>
										...
										<tbody>
											<tr>
												...
												<td colspan="5">
													...
													<input type="text" class="form-control" name="dateFrom" id="dateFrom" value="${searchVO.dateFrom}" autocomplete="off"/>
											...
											<tr>
												...
												<td>
													...
													<input type="text" id="conditionValue" class="form-control" name="searchVal" value="${searchVO.searchVal}"/>
												</td>
											...
											<tr>
												...
												<td>
													<select class="form-control" id="appMthd" name="appMthd">
														...
														<option value="ADMIN"
															<c:if test="${searchVO.appMthd eq 'ADMIN'}">selected</c:if>>ADMIN</option>
													</select>
												</td>
												<th>진행상태</th>
												<td>
						...
						<div id="btns">
							<button class="btn btn-success btn-sm" id="menu-toggle">결과</button>
							<button type="button" class="btn btn-info btn-sm" onclick="location.href='prchCnfrmApplRegister.do?appMthd=ADMIN'">등록</button>
						</div>
