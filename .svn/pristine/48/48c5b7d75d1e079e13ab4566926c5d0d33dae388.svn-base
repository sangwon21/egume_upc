...
public class ApplRcptListVO {
	...
	public void setWrtrId(String wrtId) {
		this.wrtrId = wrtId;
	}
	public String getSmplDt() {
		return smplDt;
	}
	public void setSmplDt(String smplDt) {
		this.smplDt = smplDt;
	}
	...
	public String getSamplFileId() {
		return samplFileId;
	}
	public void setSamplFileId(String samplFileId) {
		this.samplFileId = samplFileId;
	}
	...
	public String getSamplMdfReq() {
		return samplMdfReq;
	}
	public void setSamplMdfReq(String samplMdfReq) {
		this.samplMdfReq = samplMdfReq;
	}
	public String getCmfrmFileId() {
		return cmfrmFileId;
	}
	public void setCmfrmFileId(String cmfrmFileId) {
		this.cmfrmFileId = cmfrmFileId;
	}
